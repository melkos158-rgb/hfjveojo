...
| --- | --- | --- | --- | --- |
| E8 | High-intent search traffic for "virtual staging" converts at ≥ 2 % at $15/photo | **Live since 2026-09-26 22:15 (in Google review)**: Search, US, 15 exact/phrase keywords, 1 RSA, Maximize clicks ≤ €1.50, **campaign total €30 for 26 Sep – 1 Oct** (`docs/GOOGLE_ADS_EXPERIMENT.md`); owner adds negatives + turns off auto-apply | €30 | publish click may need the owner |
