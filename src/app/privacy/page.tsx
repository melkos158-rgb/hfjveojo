...
export default function PrivacyPage() {
  return (
    <div className="container-x max-w-3xl py-12 prose-basic">
      ...
      <h2>Processors</h2>
      <p>Stripe (payments), Railway (hosting, EU/US regions), OpenAI and Anthropic (AI generation), Resend (transactional email), Google (Analytics, when enabled).</p>
    </div>
  );
}
