  ...
  return (
    <div className="container-x max-w-3xl py-12 prose-basic">
      ...
      <ul>
        ...
        <li>
          <strong>Usage data</strong> — first-party analytics: page views, which tool page you came from, campaign parameters (utm) and an anonymous session id. IP addresses are stored only as a truncated hash for abuse prevention. No third-party advertising trackers.
        </li>
        <li>
      ...
      <h2>Cookies</h2>
      <p>
        Essential cookies only: a session cookie when you sign in, a first-visit attribution cookie (campaign parameters) and an anonymous session id. You can delete them in your browser at any time.
      </p>
      <h2>Your rights</h2>
      <p>
      ...
      <h2>Processors</h2>
      <p>Stripe (payments), Railway (hosting, EU/US regions), OpenAI and Anthropic (AI generation), Resend (transactional email).</p>
    </div>
  );
}
