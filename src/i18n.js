...
const T = {
  pl: {
    ...
    spec_title: 'Specyfikacja', spec_material: 'Materiał', spec_color: 'Kolor', spec_weight: 'Waga', spec_lead: 'Czas realizacji', spec_warranty: 'Gwarancja', warranty_val: '30 dni wymiany', days: 'dni', stock_left: 'Sztuk w magazynie',
  ...
  en: {
    ...
    spec_title: 'Specification', spec_material: 'Material', spec_color: 'Colour', spec_weight: 'Weight', spec_lead: 'Lead time', spec_warranty: 'Warranty', warranty_val: '30-day replacement', days: 'days', stock_left: 'Units in stock',
